...
const COUNTRY_FLAGS = [
  ...
  { pattern: /\b(Togo|Togolese|Lome|Lomé)\b/i, flag: '\u{1F1F9}\u{1F1EC}' },
  { pattern: /\b(Mauritania|Mauritanian|Nouakchott)\b/i, flag: '\u{1F1F2}\u{1F1F7}' },
  { pattern: /\b(Ecuador|Ecuadorian|Quito|Guayaquil)\b/i, flag: '\u{1F1EA}\u{1F1E8}' },
  ...
  { pattern: /\b(Turkey|Türkiye|Turkiye|Turkish|Ankara|Istanbul|Erdogan|Erdoğan)\b/i, flag: '\u{1F1F9}\u{1F1F7}' },
